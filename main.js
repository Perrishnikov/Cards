// Deck functions on HTML
      ...
      function init() {
        ...
        deck.makeDeck(numDecks); //set initial # of decks. to stack.js Stack()
      ...
      function deal() {
        ...
        if (deck.cardCount() < numDealt) //run cardCount
          ...
          for (var i = 0; i < numDealt; i++)
            hand.addCard(deck.deal()); //from... hand is running addCard, taken from deck
            //console.log(hand.cards.toString()); //Log card strig to consoe
